...
function modPost() {
	...
	if (!$(this).hasClass('follow')) { //Regular post
		...
		var top = '<div class="topdata"><ul><li class="postType"></li>';
		...
		top += '<p class="top-meta">by <a href="' + userLink + '">' + userName + '</a> ' + time + ' ago</p>';
		top += '</div>';
